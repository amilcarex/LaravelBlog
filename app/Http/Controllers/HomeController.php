...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $high = (round(($high_per_month + 5 / 2) / 5) * 5) + 10;
        ...
        return view('dashboard', ['tasks_statistics' => $tasks_statistics, 'visits_statistics' => $visits_statistics, 'pending_tasks' => $pending_tasks]);
    }
}
