...
<body class="{{ $class ?? '' }}">
  ...
  <!-- Alerts -->
  @if(session('success') && session('success') == 'created')
  <div id="record_created" class="d-none"></div>
  @endif
  @if(session('success') && session('success') == 'edited')
  <div id="record_edited" class="d-none"></div>
  @endif
  @if(session('success') && session('success') == 'deleted')
  <div id="record_deleted" class="d-none"></div>
  @endif

  @if(session('error') && session('error') == 'current_password_error')
  <div id="current_password_error" class="d-none"></div>
  @endif
  ...
  @endif
  @if(session('error') && session('error') == 'only_owner')
  <div id="only_owner" class="d-none"></div>
  @endif
  ...
  <script src="https://cdn.tiny.cloud/1/4tnute4fgjaikf37cmjgw3ie4x4btlz47n6885mfvk3orapy/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
